...
public class SuccessActivity extends AppCompatActivity {
    ...
    private void getdata() {
        ...
        JsonArrayRequest jsonArrayRequest = new JsonArrayRequest("http://192.168.0.103/project/android/feed.php", new Response.Listener<JSONArray>() {
            @Override
    ...
    public void search(View view) {
        Intent intent = new Intent(SuccessActivity.this, Searchtext.class);
        startActivity(intent);
    }

    public void addpost(View view){
        Intent intent = new Intent(SuccessActivity.this, AddPost.class);
        startActivity(intent);
